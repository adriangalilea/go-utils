...
func (c *currencyOps) USD(value float64) string {
...
func (c *currencyOps) BTC(value float64) string {
...
func (c *currencyOps) ETH(value float64) string {
...
func (c *currencyOps) Auto(value float64, currencyCode string) string {
...
func (c *currencyOps) Plain(value float64, currencyCode string) string {
	decimals := Currency.GetOptimalDecimals(value, currencyCode)
	format := fmt.Sprintf("%%.%df", decimals)
	symbol := Currency.GetSymbol(currencyCode)
...
func (c *currencyOps) Percentage(value float64) string {
	decimals := 1
...
// PercentageChange formats the percentage change between two values
func (c *currencyOps) PercentageChange(oldValue, newValue float64) string {
	change := Currency.PercentageChange(oldValue, newValue)
	return c.Percentage(change)
}